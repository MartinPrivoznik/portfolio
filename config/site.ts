...
export const siteConfig = {
  ...
  experiences: [
    ...
    },
    {
      ...
      url: "prahacoding.cz",
      description:
        "I managed to talk to students and pass them my knowledge of web development and the best practices. The language I taught them was PHP (not like I'm proud of that but it's a fact)",
      logoUrl:
