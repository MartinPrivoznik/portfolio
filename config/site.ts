...
export const siteConfig = {
  ...
  links: {
    ...
    linkedIn: "https://www.linkedin.com/in/marprivoznik/",
  ...
  experiences: [
    {
      name: "BOOTIQ",
      period: "mar2024todec2024",
      role: "bootiqRole",
      length: "9months",
      urlText: "bootiq.io",
      url: "https://www.bootiq.io/",
      description: "bootiqDesc",
      logoUrl: "/images/companies/bootiq_logo.jpg",
      skills: [
        { text: "C#", importance: "primary" },
        { text: "ASP.NET Core", importance: "primary" },
        { text: "MongoDB", importance: "default" },
        { text: "CQRS", importance: "default" },
        { text: "MSSQL", importance: "default" },
      ],
    },
    {
      name: "Valatron",
      period: "apr2022tomar2024",
      role: "valatronLeadRole",
      length: "2yr",
      urlText: "valatron.com",
      url: "https://www.valatron.com/",
      description: "valatronLeadDesc",
      logoUrl: "/images/companies/valatron.png",
      skills: [
        { text: "C#", importance: "primary" },
        { text: "ASP.NET Core", importance: "primary" },
        { text: "CI/CD", importance: "default" },
        { text: "Architecture", importance: "default" },
        { text: "Leadership", importance: "default" },
        { text: "MSSQL", importance: "default" },
      ],
    },
    {
      name: "Valatron",
      period: "jul2020toapr2022",
      role: "valatronRole",
      length: "1yr10mo",
      urlText: "valatron.com",
      url: "https://www.valatron.com/",
